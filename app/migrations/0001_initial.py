# Generated by Django 3.2.8 on 2023-01-10 03:52
...
def insert_init_data(apps, schema_editor):
    ...
    TipoProductor.objects.create(nombre='PEQUEÑO')
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('year', models.PositiveIntegerField(max_length=4, unique=True)),
                ('costo_total_produccion', models.DecimalField(decimal_places=2, max_digits=19)),
                ('rentabilidad', models.DecimalField(decimal_places=2, max_digits=19)),
            ],
        ),
        migrations.CreateModel(
            name='Tipo_Productor',
